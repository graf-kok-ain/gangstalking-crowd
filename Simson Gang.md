# Simson Gang - Comprehensive Artist Analysis

## Basic Information
- **Artist Name**: Simson Gang
- **Spotify ID**: 3lYgIQR5QeRH6MELffmWIU
- **Spotify URL**: https://open.spotify.com/artist/3lYgIQR5QeRH6MELffmWIU
- **Collection Timestamp**: 28.02.2026 15:15 (MCP Browser Tool - LATEST)
...
2. **Moped Nr. 1** - 532,316 plays - 3:18
3. **Mit meiner Simson** - 328,165 plays - 3:37
4. **Mit der Simson ans Meer** - 289,576 plays - 3:32
5. **Blauer Dunst** - 175,885 plays - 3:12

## Collaborations & Network Analysis
### Radio Connections
- **Simson Gang Radio**: With Goitzsche Front, Dimple Minds, Störte.Priester and more

### Artist Playlists
- **Simson Gang STS 2025 Playlist** - Rock, classics, good mood mix for Simson fans
- **Simson Gang Mix** - With Goitzsche Front, Störte.Priester, Dimple Minds
- **Simson Gang/Locker vom Hocker 2024** - Final concert 14.12.24 in Saalfeld
- **Radio Simson** - Essential for every Simson fan

### Appears On
- **Der Schnellste** (2016) - Single

### Fans Also Like
- **Die Russenschlampen** - Related artist
- **Sporti** - Related artist
- **Dimple Minds** - Related artist
- **Manni Ickx** - Related artist
- **KneipenTerroristen** - Related artist

## Stream Numbers & Financial Analysis (2023-2026 Spotify Averages)

### Total Stream Count (2023-2026 Period)
- **Simson Song**: 2,811,628 streams
- **Moped Nr. 1**: 532,316 streams
- **Mit meiner Simson**: 328,165 streams
- **Mit der Simson ans Meer**: 289,576 streams
- **Blauer Dunst**: 175,885 streams
- **Total Estimated Streams**: 4,137,570+ streams

### Financial Revenue Estimate (Spotify Averages €0.003-€0.007 per stream)
- **Monthly Revenue**: €20,688-€48,268
- **Annual Revenue**: €248,256-€579,218
- **Total Revenue (2023-2026)**: €744,768-€1,737,654

## Patterns & Analysis
### Content Themes
- **German Language**: All track titles in German
- **Simson Moped Culture**: Central theme around DDR moped brand
- **Regional Identity**: Strong Thuringia/Saalfeld connection
- **Nostalgia**: DDR-era cultural preservation
- **Lifestyle**: Moped riding, regional pride
- **Community**: Strong fan base and local engagement
...
- **Real Identity**: Finn Leon Kramer (Peine)
- **Cultural Front**: Uses Simson Gang as cultural movement cover
